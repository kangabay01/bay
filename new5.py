...
cl = TZK.LINE()
#cl.login(qr=True)
cl.login(token='EsQq1RXFxox78j19lq0f.XC+aIRfWpnuEFu8PNfop7W.1MmH4FBfYlQsOEs3L5FTflHDpkL5LZDU0ZGqXpWqJ/M=')
cl.loginResult()
print "Cl-Login Success\n"

ki = TZK.LINE()
#ki.login(qr=True)
ki.login(token='Es5aluXWSwHRu6G7dyF5.6iJVw6WoVfDeOslSoYzJTq.w7v+JHc5rwCuP/D9aKKFZPB50QKHYCfmFmJnt6VU64M=')
ki.loginResult()
print "Ki-Login Success\n"

kk = TZK.LINE()
#kk.login(qr=True)
kk.login(token='EsbNDRe77rWyCgYE34V7.OnFKZAyWUBkVM92/Ev9Z1W.J/30wiYH/EYVdPP7OEz/96/jhMdVPZJJktURSoiMc2g=')
kk.loginResult()
print "Kk-Login Success\n"

kc = TZK.LINE()
#kc.login(qr=True)
kc.login(token='EsGaURLlLWyrEuMbGTKc.i4sq1yzhqc+u0Ty4Mq9hJa.PVxrg+OzMl/Z6nBSzn/g77QgDcWZLuSzdHgX15z1gKA=')
kc.loginResult()
print "Kc-Login Success\n"

kr = TZK.LINE()
#kr.login(qr=True)
kr.login(token='EsIO0dwqSUT4lbZSu245.ldFbAYE6IAb/XrilBi4qjq.PyKsIjKSbTgxBEDZgLyOmt7aFkx7loc2949/jGVPGpE=')
kr.loginResult()
print "Kr-Login Success\n"

luly = TZK.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#abay.login(qr=True)
luly.login(token='EsYBOKrRDVv08IFDlN7e.ZihTRbq7Q53w6bcBupXkdG.UbO2KJHymVroc+qAa0SFffU+kQZwvDG7deD2odwfkFQ=')
luly.loginResult()
print "luly-Login Success\n"

km = TZK.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EsDL6S3peG8s6dVrYzh7.4jeQR0Shg2K1caoJqzzTbW.ZzP4EWEOhF1MYkDLxKfVCwEeoXAQkXDNXJzQvP8F0/I=')
km.loginResult()
...
Urlgroup image
"""
tjia="ucc81edac143bab9dd6e8109b50fc4a0e"
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : டΰட௶ ᴮᴼᵀ\nContact Me : 👉 line.me/ti/p/awbnSjzR6V" ,
...
#                                        cl.sendImageWithURL(op.param1,image)
                                        d = Message(to=op.param1, from_=None, text=None, contentType=7)
                                        d.contentMetadata = {"STKID": "15513542","STKPKGID": "1400513","STKVER": "1"}              
                                        cl.sendMessage(d)
 ...
 #                                   time.sleep(0.2)
    ...
    #                                cl.sendImageWithURL(op.param1,image)
                                    d = Message(to=op.param1, from_=None, text=None, contentType=7)
                                    d.contentMetadata = {"STKID": "27610709","STKPKGID": "1897200","STKVER": "1"}              
                                    cl.sendMessage(d)
                                    cl.sendText(op.param1, "Nᴀʜʜʜ " + "☞ " + Name + " ☜" + "\nsini kaka masuk ga usah malu malu \nHᴀʜᴀʜᴀ   ")
                        else:
                            pass
                    else:
                        pass
...
#		else:                    
		    ...
		    cl.sendText(msg.to,"Khusus Admin")
              ...
              if msg.from_ in admin:
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Siap berburu")
...
#                if msg.from_ in Creator:
                 ...
                 cl.sendMessage(cnt)   
                 cnt = Message()
                 cnt.text = "❨ᴍᴇɴᴛɪᴏɴᴇs ʙʏ : 🤖 •༺༽།☤ⵓః••டΰட௶ ᴮᴼᵀ••ఃⵓ☤།༼༻•🤖❩"
                 cnt.to = msg.to
                 cl.sendMessage(cnt)
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "ucc81edac143bab9dd6e8109b50fc4a0e"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		try:
		    ...
		    wait["Leave"] = False
             ...
             if msg.from_ in admin and Creator:
                cl.sendText(msg.to,"kadarieu kadarieu kadarieu!!")
                ki.sendText(msg.to,"Ada apa sih..!!")
                 ...
                 if wait["detectMention4"] == True:
                     ...
                     for mention in mentionees:
                           if mention['M'] in admin:
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '33237800',
                                    'STKPKGID': '3145354',
                                    'STKVER': '1'}
                                  cl.sendMessage(msg)  
                                  break   
                 ...
                 if wait["detectMention5"] == True:          
                    ...
                    for mention in mentionees:
                           if mention['M'] in admin:
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '17773516',
                                    'STKPKGID': '1480028',
                                    'STKVER': '1'}
                                  cl.sendMessage(msg)                                
                                  break
                 ...
                 if wait["detectMention6"] == True:          
                    ...
                    for mention in mentionees:
                           if mention['M'] in admin:
                                  ...
                                  msg.contentType = 7    
                                  msg.text = None
                                  msg.contentMetadata = {'STKID': '22050050',
                                    'STKPKGID': '1673952',
                                    'STKVER': '1'}
